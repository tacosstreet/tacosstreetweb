...
const categories: Category[] = [
  {
    ...
    items: [
      { name: 'Queso Casera', emoji: '🧀', gradient: 'linear-gradient(135deg,#FFD600,#ca8a04)', desc: 'Nuestra salsa de queso fundido hecha en casa. Cremosa y adictiva. La firma de Tacos Street — va en todos los tacos.', origin: 'Receta propia', img: '/img/salsas/processed/queso.webp' },
      ...
      { name: 'Samouraï', emoji: '⚔️', gradient: 'linear-gradient(135deg,#dc2626,#7f1d1d)', desc: 'Naranja intenso, base de mayonesa con harissa y especias. Potente y adictiva. Imprescindible en cualquier tacos francés que se precie.', origin: 'Francia', heat: 2, img: '/img/salsas/processed/samourai.webp' },
      { name: 'Biggy', emoji: '🍔', gradient: 'linear-gradient(135deg,#d97706,#92400e)', desc: 'Tipo burger sauce, dulce y ahumada. Como la salsa Big Mac pero versión francesa — más intensa y con más carácter.', origin: 'Francia', img: '/img/salsas/processed/biggy.webp' },
      { name: 'Brasil', emoji: '🌴', gradient: 'linear-gradient(135deg,#16a34a,#064e3b)', desc: 'Suave y tropical con notas afrutadas. Perfecta con pollo y piña. La clave del Taco Tropical.', origin: 'Inspiración brasileña', img: '/img/salsas/processed/brazil.webp' },
      { name: 'Andalouse', emoji: '🫒', gradient: 'linear-gradient(135deg,#ea580c,#9a3412)', desc: 'Tomate, pimiento y mayonesa. Suave, ligeramente dulce y versátil. No pica nada. Para ir a lo seguro.', origin: 'Bélgica / Francia', img: '/img/salsas/processed/andalouse.webp' },
      { name: 'Tasty', emoji: '😋', gradient: 'linear-gradient(135deg,#ca8a04,#713f12)', desc: 'Cremosa con toque ahumado y dulce. El complemento perfecto del Django, nuestro taco más pedido.', origin: 'Francia', img: '/img/salsas/processed/tasty.webp' },
      { name: 'Curry', emoji: '🍛', gradient: 'linear-gradient(135deg,#eab308,#a16207)', desc: 'Curry suave y aromático. No pica, combina genial con pollo tikka.', origin: 'Inspiración india', img: '/img/salsas/processed/curry.webp' },
      { name: 'Curry-Mango', emoji: '🥭', gradient: 'linear-gradient(135deg,#f59e0b,#b45309)', desc: 'Curry suave con puré de mango. Dulce, exótica y aromática. El secreto del Taco Tropical.', origin: 'Fusión', img: '/img/salsas/processed/curry.webp' },
      { name: 'Chili Thai', emoji: '🐉', gradient: 'linear-gradient(135deg,#ef4444,#991b1b)', desc: 'Dulce y picante estilo tailandés. Jengibre y guindilla. Para los que buscan sabor potente.', origin: 'Inspiración tailandesa', heat: 2, img: '/img/salsas/processed/chilli-thai.webp' },
      { name: 'Harissa', emoji: '🔥', gradient: 'linear-gradient(135deg,#b91c1c,#450a0a)', desc: 'Guindilla roja con comino, ajo y cilantro. La más picante de todas. Solo para valientes.', origin: 'Túnez / Magreb', heat: 3, img: '/img/salsas/processed/harissa.webp' },
      { name: 'BBQ', emoji: '🪵', gradient: 'linear-gradient(135deg,#92400e,#451a03)', desc: 'Barbacoa clásica, ahumada con toque dulce. La de siempre, pero con nivel.', origin: 'Clásico', img: '/img/salsas/processed/bbq.webp' },
      { name: 'Blanca', emoji: '🤍', gradient: 'linear-gradient(135deg,#e2e8f0,#94a3b8)', desc: 'Salsa blanca suave y cremosa. Equilibra combinaciones de sabor intenso. Discreta pero esencial.', origin: 'Clásico', img: '/img/salsas/processed/blanca.webp' },
      { name: 'Ketchup', emoji: '🍅', gradient: 'linear-gradient(135deg,#dc2626,#7f1d1d)', desc: 'El clásico de siempre. Sencillo y efectivo.', origin: 'Clásico', img: '/img/salsas/processed/ketchup.webp' },
      { name: 'Mayonesa', emoji: '🥣', gradient: 'linear-gradient(135deg,#fef9c3,#a16207)', desc: 'Mayonesa cremosa. La base neutra que equilibra cualquier combinación intensa.', origin: 'Clásico', img: '/img/salsas/processed/mayonesa.webp' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Patatas con Salsa de Queso y Bacon', emoji: '🧀', gradient: 'linear-gradient(135deg,#FFD600,#ca8a04)', desc: 'Patatas fritas con salsa de queso casera y bacon. El entrante mas pedido de la carta.', origin: 'Receta propia', img: '/img/uber/patatas-fritas-con-salsa-de-queso-y-bacon.webp' },
  ...
  },
  {
    ...
    items: [
      { name: 'Hawaii Tropical', emoji: '🌺', gradient: 'linear-gradient(135deg,#f97316,#c2410c)', desc: 'Refresco tropical importado, casi imposible de encontrar en España. Piña y fruta de la pasión. La más pedida con diferencia.', origin: 'Importación', img: '/img/uber/hawai.webp' },
      { name: 'Oasis Tropical', emoji: '🏝️', gradient: 'linear-gradient(135deg,#fb923c,#ea580c)', desc: 'Frutas tropicales importado de Francia. No se vende en supermercados españoles. Menos dulce y más refrescante.', origin: 'Francia', img: '/img/uber/oasis-tropical.webp' },
      { name: 'Oasis Manzana-Frambuesa', emoji: '🍎', gradient: 'linear-gradient(135deg,#f43f5e,#9f1239)', desc: 'Manzana y frambuesa de Oasis Francia. Refrescante y ligeramente ácida.', origin: 'Francia', img: '/img/uber/oasis-manzana-frambuesa.webp' },
      { name: 'Oasis Manzana-Pera', emoji: '🍐', gradient: 'linear-gradient(135deg,#84cc16,#365314)', desc: 'Manzana y pera de Oasis Francia. Suave y muy refrescante.', origin: 'Francia', img: '/img/uber/oasis-manzana-pera.webp' },
      { name: '7UP Mojito Menta', emoji: '🍃', gradient: 'linear-gradient(135deg,#4ade80,#15803d)', desc: 'Sabor mojito (menta y lima). Sin alcohol. Exclusiva y refrescante. No la encuentras en otro sitio de Zaragoza.', origin: 'Importación', img: '/img/uber/7up-mojito-menta.webp' },
      { name: 'Coca-Cola', emoji: '🥤', gradient: 'linear-gradient(135deg,#dc2626,#7f1d1d)', desc: 'El clásico que nunca falla. La lata de siempre.', origin: 'Clásico', img: '/img/uber/coca-cola.webp' },
      { name: 'Coca-Cola Zero', emoji: '🥤', gradient: 'linear-gradient(135deg,#1c1917,#57534e)', desc: 'Mismo sabor Coca-Cola, sin azúcar.', origin: 'Clásico', img: '/img/uber/coca-cola-zero.webp' },
      { name: 'Fanta Naranja', emoji: '🍊', gradient: 'linear-gradient(135deg,#f97316,#7c2d12)', desc: 'El refresco de naranja más conocido. Dulce y burbujeante.', origin: 'Clásico', img: '/img/uber/fanta-naranja.webp' },
      { name: 'Fanta Limón', emoji: '🍋', gradient: 'linear-gradient(135deg,#fde047,#a16207)', desc: 'Refresco de limón refrescante y ligeramente ácido.', origin: 'Clásico', img: '/img/uber/fanta-limon.webp' },
      { name: 'Fanta Tropical', emoji: '🌴', gradient: 'linear-gradient(135deg,#fb923c,#d97706)', desc: 'Sabor tropical con mezcla de frutas. Diferente y refrescante.', origin: 'Clásico', img: '/img/uber/fanta-tropical.webp' },
      { name: 'Fanta Dragón & Mango', emoji: '🐉', gradient: 'linear-gradient(135deg,#c026d3,#7e22ce)', desc: 'Fruta del dragón y mango. Sabor exótico y único. Una de las exclusivas de la carta.', origin: 'Exclusiva', img: '/img/uber/fanta-fruta-del-dragon-y-mango.webp' },
      { name: 'Fuze Tea Limón', emoji: '🍵', gradient: 'linear-gradient(135deg,#fde68a,#92400e)', desc: 'Té negro con limón y un toque dulce. Refrescante alternativa al refresco clásico.', origin: 'Importación', img: '/img/uber/fuze-tea-limon.webp' },
      { name: 'Fuze Tea Maracuyá', emoji: '🌺', gradient: 'linear-gradient(135deg,#f59e0b,#b45309)', desc: 'Té negro con maracuyá. Tropical y refrescante. Perfecta con el Taco Tropical.', origin: 'Importación', img: '/img/uber/fuze-tea-maracuya.webp' },
      { name: 'Monster Energy', emoji: '⚡', gradient: 'linear-gradient(135deg,#4ade80,#14532d)', desc: 'La energética clásica de Monster. Para los que necesitan un extra.', origin: 'Importación', img: '/img/uber/monster-energy.webp' },
      { name: 'Monster Mango Loco', emoji: '🥭', gradient: 'linear-gradient(135deg,#f59e0b,#78350f)', desc: 'Monster sabor mango. Más suave que el original y con sabor tropical.', origin: 'Importación', img: '/img/uber/monster-mangoloco.webp' },
      { name: 'Monster Ultra Zero', emoji: '🤍', gradient: 'linear-gradient(135deg,#e2e8f0,#475569)', desc: 'Monster sin azúcar. Mismo efecto, sin las calorías.', origin: 'Importación', img: '/img/uber/monster-ultra-zero-azucar.webp' },
      { name: 'Monster Fresa Cero', emoji: '🍓', gradient: 'linear-gradient(135deg,#f43f5e,#881337)', desc: 'Monster sabor fresa sin azúcar. Refrescante y sin calorías.', origin: 'Importación', img: '/img/uber/monster-fresa.webp' },
      { name: 'Capri-Sun', emoji: '🧃', gradient: 'linear-gradient(135deg,#f97316,#9a3412)', desc: 'El zumo en bolsita más icónico. Para los que no crecen nunca.', origin: 'Clásico', img: '/img/uber/capri-sun.webp' },
      { name: 'Poms', emoji: '🍎', gradient: 'linear-gradient(135deg,#dc2626,#7f1d1d)', desc: 'Refresco de manzana importado. Suave y natural.', origin: 'Importación', img: '/img/uber/poms.webp' },
      { name: 'Agua', emoji: '💧', gradient: 'linear-gradient(135deg,#7dd3fc,#0c4a6e)', desc: 'Agua mineral. Siempre disponible.', origin: 'Clásico', img: '/img/uber/agua.webp' },
    ],
  },
];
